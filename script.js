    ...
    methods: {
        ...
        pokemonInfo() {
            ...
            axios.all([
                ...
                self.name = pokemonStats.name.replace(pokemonStats.name.charAt(0), pokemonStats.name.charAt(0).toUpperCase());
                self.hp = pokemonStats.stats[5].base_stat;
                self.type1 = pokemonStats.types[0].type.name.replace(pokemonStats.types[0].type.name.charAt(0), pokemonStats.types[0].type.name.charAt(0).toUpperCase());
                if (pokemonStats.types.length == 2) {
                    self.type2 = `/` + pokemonStats.types[1].type.name.replace(pokemonStats.types[1].type.name.charAt(0), pokemonStats.types[1].type.name.charAt(0).toUpperCase());
                } else {
                    self.type2 = '';
                }
